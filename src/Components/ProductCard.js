...
const ProductCard = ({image,heading,desc,icon}) => {
  return (
    <div className="w-3/12  rounded-xl overflow-hidden border-[1px] border-black m-0 p-0 relative bg-[#551F64]">
      <img
        src={image}
        alt="frame"
        className="object-cover object-bottom w-full"
      />
      <div className="w-full  bg-[#551F64] rounded-t-3xl relative top-[-20px] p-4">
        <img
          src={icon}
          alt="vector"
